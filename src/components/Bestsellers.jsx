        ...
        {loading && !bestsellers.length ? (
          ...
          <div>
            <div
              ref={railRef}
              dir="ltr"
              className="mobile-carousel flex gap-4 overflow-x-auto pb-4 px-1 -mx-1 snap-x snap-mandatory scroll-smooth overscroll-x-contain md:gap-6 select-none"
            >
              {bestsellers
                      ...
                      <div className="min-h-[92px] bg-[#eef4fb] px-5 py-4 text-center md:min-h-[110px] md:px-6 md:py-5">
                        ...
                        <div className="mt-1.5 flex items-center justify-center gap-2">
                          ...
                          <p className="text-xs text-slate-500 line-through">
                            {Number(product.originalPrice ?? product.price * 2).toFixed(2)} {ui.aed}
                          </p>
                        </div>
                      </div>
                    </div>
